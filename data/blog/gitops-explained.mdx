...
date: '2024-07-13'
lastmod: '2024-07-13'
tags: ['gitops', 'tutorial', 'infrastructure']
summary: 'Enter GitOps, the magic that turns your infrastructure into code you can control with a simple "git push." '
layout: PostLayout
---

![thumbnail-image](/static/images/blogs/posts/05-gitops-explained.png)
