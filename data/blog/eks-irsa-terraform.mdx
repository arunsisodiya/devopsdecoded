...
date: '2024-05-15'
lastmod: '2024-05-15'
tags: ['tutorial', 'eks', 'security', 'terraform', 'irsa', 'kubernetes']
summary: 'Understand the power of IRSA in Kubernetes cluster and secure your cluster from leaked credentials !'
layout: PostLayout
---

![thumbnail-image](/static/images/blogs/posts/02-eks-irsa-terraform.webp)
